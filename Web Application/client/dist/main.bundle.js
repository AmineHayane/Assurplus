...
var MoncompteComponent = (function () {
    function MoncompteComponent(elRef, servicePassword, authService, router, elref) {
        var _this = this;
        this.elRef = elRef;
        ...
        this.identityFieldsReadOnly = true;
        this.identityModified = false;
    ...
    MoncompteComponent.prototype.ngOnInit = function () {
        ...
        this.authService.retrieveUser(userEmail).subscribe(function (user) {
            _this.User = user;
            if (_this.User.UserBirthDate !== undefined) {
            }
            ;
            console.log(_this.User);
            for (var prop in _this.User) {
                _this.keysUserObject.push(prop);
                if (_this.User[prop] == undefined || _this.User[prop] == '') {
                    console.log(prop);
                    _this.notFilled += 1;
                }
            }
            console.log(_this.keysUserObject);
            console.log(_this.notFilled);
            _this.percentageCalcul(_this.notFilled, _this.keysUserObject.length);
        });
    };
    MoncompteComponent.prototype.percentageCalcul = function (notFilled, length) {
        this.percentageProfile = Math.round(100 - (notFilled * 100) / (length - 5));
    };
    MoncompteComponent.prototype.redoPercentageCalcul = function () {
    ...
    MoncompteComponent.prototype.toggleReadOnlyFields = function () {
        this.identityFieldsReadOnly = (this.identityFieldsReadOnly === false ? true : false);
        this.isModified1 = true;
    };
    MoncompteComponent.prototype.toggleAddPhone = function () {
        this.isModifiedPhone = true;
    };
    MoncompteComponent.prototype.ngAfterViewChecked = function () {
    };
    ...
    MoncompteComponent.prototype.onSubmitInfos = function (data) {
        ...
        this.authService.updateUser(this.User).subscribe(function (user) {
            console.log(user);
            _this.identityModified = true;
            console.log(_this.identityModified);
            _this.redoPercentageCalcul();
        });
    };
...
var ProduitComponent = (function () {
    ...
    ProduitComponent.prototype.computeDuration = function () {
    ...
    ProduitComponent.prototype.computeValue = function () {
