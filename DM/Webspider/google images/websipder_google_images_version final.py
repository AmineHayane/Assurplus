...
print "Nous sommes équipe de ENSAM: Amine, Boubker, Bin"

name = raw_input("Please input the name:")
query= name.split()
query='+'.join(query)
url="https://www.google.fr/search?q="+query+"&espv=2&biw=1366&bih=662&site=webhp&source=lnms&tbm=isch&sa=X&sqi=2&ved=0ahUKEwjV1I_U373SAhVDtRoKHURNB8UQ_AUIBygC"
print url
